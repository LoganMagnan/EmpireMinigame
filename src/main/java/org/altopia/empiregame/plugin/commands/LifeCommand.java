...
public class LifeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!this.main.getAbilityManager().canUseAbility(player, AbilityType.THE_EVERLIVE)) {
            return true;
        }

        player.addPotionEffect(new PotionEffect(PotionEffectType.ABSORPTION, 1000, 6));
