...
public class MongoManager {
    ...
    public MongoManager() {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(Utils.translate("&d[EmpireGame] &aSuccessfully connected to the database!"));
            this.players = this.mongoDatabase.getCollection("players");
            this.ranks = this.mongoDatabase.getCollection("ranks");
        } catch (Exception exception) {
            connected = false;
            Bukkit.getConsoleSender().sendMessage(Utils.translate("&d[EmpireGame] &cFailed to connect to the database!"));
            exception.printStackTrace();
            Bukkit.getPluginManager().disablePlugin(this.main);
            Bukkit.getConsoleSender().sendMessage(Utils.translate("&b[EmpireGame] &cDisabling EmpireGame..."));
        }
    }
    ...
    public void disconnect() {
        if (this.mongoClient != null) {
            ...
            Bukkit.getConsoleSender().sendMessage(Utils.translate("&d[EmpireGame] &aSuccessfully disconnected from the database!"));
        }
    }
